        ...
        try {
            ...
            if (relationshipRepositoryForClass != null) {
                if (Iterable.class.isAssignableFrom(baseRelationshipFieldClass)) {
                    return ((MetaRepository)relationshipRepositoryForClass).getMetaInformation(root, Collections.singletonList(relationshipRepositoryForClass), requestParams, castedResourceId);
                }
            }
